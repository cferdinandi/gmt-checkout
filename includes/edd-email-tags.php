<?php
	...
	/**
	 * @section Add product names tag to emails
	 */
	 ...
	 */
	function gmt_edd_custom_get_purchase_downloads ( $payment_id = 0 ) {
	...
	function gmt_edd_custom_get_download_list_names ( $payment_id ) {
		$files = gmt_edd_custom_get_purchase_downloads( $payment_id );
