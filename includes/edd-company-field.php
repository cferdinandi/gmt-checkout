<?php
	 ...
	 */
	function keel_edd_store_company_name_field( $payment_meta ) {
	...
	add_filter( 'edd_payment_meta', 'keel_edd_store_company_name_field');
	 ...
	 */
	function keel_edd_add_company_to_view_order_details( $payment_meta, $user_info ) {
	...
	add_action( 'edd_payment_personal_details_list', 'keel_edd_add_company_to_view_order_details', 10, 2 );
	 ...
	 */
	function keel_edd_email_tag_company( $payment_id ) {
	 ...
	 */
	function keel_edd_add_company_name_email_tag() {
		edd_add_email_tag( 'company', 'Company name', 'keel_edd_email_tag_company' );
	}
	add_action( 'edd_add_email_tags', 'keel_edd_add_company_name_email_tag' );