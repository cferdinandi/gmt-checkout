<?php
	...
	/**
	 * @section Add links to products in cart
	 */
	 ...
	 */
	function gmt_edd_add_links_to_cart_items ( $item ) {
	 ...
	 */
	function gmt_edd_create_product_page_link_metabox () {
	...
	add_action( 'add_meta_boxes', 'gmt_edd_create_product_page_link_metabox' );
	 ...
	 */
	function gmt_edd_render_product_page_link_metabox () {
		...
		wp_nonce_field( 'gmt_edd_product_page_link_metabox_nonce', 'gmt_edd_product_page_link_metabox_process' );
	}
	 ...
	 */
	function gmt_edd_save_product_page_link_metabox ( $post_id, $post ) {

		if ( !isset( $_POST['gmt_edd_product_page_link_metabox_process'] ) ) return;

		// Verify data came from edit screen
		if ( !wp_verify_nonce( $_POST['gmt_edd_product_page_link_metabox_process'], 'gmt_edd_product_page_link_metabox_nonce' ) ) {
			return $post->ID;
		}
